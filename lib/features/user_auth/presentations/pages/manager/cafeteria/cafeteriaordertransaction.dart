...
class CafeteriaOrderTransactionsPage extends StatelessWidget {
  const CafeteriaOrderTransactionsPage({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Cafeteria Order Transactions'), // Changed from 'Canteen Order Transactions'
      ),
      body: StreamBuilder<QuerySnapshot>(
        ...
        builder: (context, snapshot) {
          ...
          if (snapshot.data!.docs.isEmpty) {
            return const Center(
              child: Text(
                'No past cafeteria orders found', // Changed from 'No past canteen orders found'
