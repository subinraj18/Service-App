...
class AddCanteenProduct extends StatefulWidget {
  @override
  _AddCanteenProductState createState() => _AddCanteenProductState();
}

class _AddCanteenProductState extends State<AddCanteenProduct> {
  ...
  Future<void> _saveProduct() async {
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        DocumentReference docRef = await FirebaseFirestore.instance.collection('canteenproducts').add({
          'productId': productId,
        ...
        print('Canteen product added with ID: ${docRef.id}, productId: $productId');
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Product added successfully')),
        );
        Navigator.pop(context);
      } catch (e) {
        print('Error adding canteen product: $e');
        ScaffoldMessenger.of(context).showSnackBar(
  ...
  void _navigateToDeleteProductPage() {
    Navigator.push(
      context,
      MaterialPageRoute(builder: (context) => DeleteCanteenProductPage()),
    );
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Add Canteen Product'),
        actions: [
          IconButton(
