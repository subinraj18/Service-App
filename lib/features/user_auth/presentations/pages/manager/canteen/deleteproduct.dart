...
class DeleteCanteenProductPage extends StatefulWidget {
  @override
  _DeleteCanteenProductPageState createState() => _DeleteCanteenProductPageState();
}

class _DeleteCanteenProductPageState extends State<DeleteCanteenProductPage> {
      ...
      setState(() {
        products = snapshot.docs.map((doc) {
          ...
          return {
            ...
            'image': data['image'] ?? 'assets/images/goal.png',
