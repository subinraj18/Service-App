...
class CanteenAnalysisPage extends StatefulWidget {
  const CanteenAnalysisPage({Key? key}) : super(key: key);

  @override
  _CanteenAnalysisPageState createState() => _CanteenAnalysisPageState();
}

class _CanteenAnalysisPageState extends State<CanteenAnalysisPage>
  ...
  Future<void> _fetchProductsWithReviews() async {
    ...
    try {
      print('Fetching products from canteenproducts...');
      QuerySnapshot productSnapshot =
      await FirebaseFirestore.instance.collection('canteenproducts').get();
      print('Fetched ${productSnapshot.docs.length} products');

      print('Fetching reviews from canteenproduct_reviews...');
      QuerySnapshot reviewSnapshot = await FirebaseFirestore.instance
          .collection('canteenproduct_reviews')
          .get();
      ...
      print('Error fetching canteen products with reviews: $e');
