...
class Moreupdate extends StatefulWidget {
...
class _CampusUpdatesPageState extends State<Moreupdate> with SingleTickerProviderStateMixin {
  ...
  Future<void> _checkManagerStatus() async {
    ...
    if (user != null) {
      setState(() {
        _isManager = user.email == "main@gmail.com"; // Manager email check
      });
    }
  }
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: Text(
                                  _isManager ? 'Share news with the campus community' : 'View the latest campus news',
                                  style: GoogleFonts.poppins(
                                    fontSize: 14,
        ...
        children: [
          ...
          StreamBuilder<QuerySnapshot>(
            stream: FirebaseFirestore.instance
                ...
                .orderBy('timestamp', descending: true) // Removed .limit(5)
                .snapshots(),
  ...
  Widget _buildAccessDeniedSection() {
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 16),
          Text(
            'This section is restricted to campus managers. If you need to post an update, please contact the administration.',
            style: GoogleFonts.poppins(
              fontSize: 16,
          ...
          StreamBuilder<QuerySnapshot>(
            stream: FirebaseFirestore.instance
                .collection('campus_updates')
                .orderBy('timestamp', descending: true) // Removed .limit(3)
                .snapshots(),
            builder: (context, snapshot) {
              if (snapshot.connectionState == ConnectionState.waiting) {
                return Center(
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          if (_isManager) // Show delete button only for managers
            IconButton(
              icon: Icon(
